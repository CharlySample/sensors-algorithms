...
# execfile("/home/carlos/Documents/Universidad/sensores/programas/simular/simular2.py")
...
def Leonardo():
  ...
  # Primer Engran (se mueve solo)
     ...
     if t>15:
     	t=0
     move.subamorf(t, kt, ct, m, a1, a2, phi)
     sub=move.ResultSC	
     App.getDocument("simular").Part__Feature.Placement=App.Placement(App.Vector(0,sub,0), App.Rotation(0,0,0), App.Vector(t,0,0))
