...
double w1, v,xt=0.0,phi1,phi2,phi3;
/* ENGRANE -> ENGRANE
...
void delfin(int t)
{
  B.load("/home/carlos/Documents/Universidad/sensores/programas/delf/mo.txt", arma_ascii);
...
BOOST_PYTHON_MODULE(MoveModule)
{
        ...
        .def("delfin", &Movement::delfin)
        .def_readwrite("Resultphi1", &Movement::phi1)
        .def_readwrite("Resultphi2", &Movement::phi2)
        .def_readwrite("Resultphi3", &Movement::phi3)
        ;
}
